...
namespace Dziennik.ViewModel
{
    public sealed class RealizedSubjectViewModel : ViewModelBase<RealizedSubjectViewModel, RealizedSubject>
    {
        ...
        public override void CopyDataTo(RealizedSubjectViewModel viewModel)
        {
            viewModel.RealizedDate = this.RealizedDate;
            viewModel.CustomSubject = this.CustomSubject;
            viewModel.GlobalSubject = this.GlobalSubject;
        }
    }
}
